...
export default function MarketingSections() {
  return (
    <div className="w-full flex flex-col gap-24 sm:gap-32 py-10 relative z-10">
      <HowItWorksSection />
      <FeaturesSection />
  ...
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-navy dark:text-white">How It Works</h2>
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">Three simple steps to professional-grade audio.</p>
      </motion.div>
...
function FeaturesSection() {
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-navy dark:text-white">Powered by Advanced AI</h2>
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">Everything you need to create perfect audio for your videos, all in one place.</p>
      </motion.div>

      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl p-8 md:col-span-2 relative overflow-hidden group">
          ...
          <Volume2 className="text-cyan-600 dark:text-accent mb-6" size={32} />
          <h3 className="text-2xl font-bold mb-3 text-navy dark:text-white">AI Noise Removal</h3>
        ...
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl p-8 md:col-span-2 relative overflow-hidden group">
          ...
          <Zap className="text-purple mb-6" size={32} />
          <h3 className="text-2xl font-bold mb-3 text-navy dark:text-white">Browser-based Processing</h3>
        ...
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl p-8 md:col-span-1">
        ...
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl p-8 md:col-span-2 bg-gradient-to-br from-bg-light to-slate-200 dark:from-bg-dark dark:to-slate-900 border-accent/20">
...
function VideoShowcaseSection() {
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-navy dark:text-white">Hear The Difference</h2>
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">Swipe to see how ClearVoice AI rescues bad audio.</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl overflow-hidden flex flex-col group cursor-pointer">
          <div className="h-48 bg-slate-200 dark:bg-slate-800 relative flex items-center justify-center overflow-hidden">
             <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10" />
             <Play className="text-white z-20 opacity-80 group-hover:scale-110 transition-transform" size={48} />
             <div className="absolute bottom-4 left-4 z-20 text-white font-medium">Outdoor Vlog</div>
        ...
        <motion.div variants={fadeInUp} className="glass-card rounded-3xl overflow-hidden flex flex-col group cursor-pointer">
          <div className="h-48 bg-slate-200 dark:bg-slate-800 relative flex items-center justify-center overflow-hidden">
             <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10" />
             <Play className="text-white z-20 opacity-80 group-hover:scale-110 transition-transform" size={48} />
             <div className="absolute bottom-4 left-4 z-20 text-white font-medium">Podcast Interview</div>
             <div className="absolute bottom-4 right-4 z-20 flex gap-2">
...
function TestimonialsSection() {
  ...
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-navy dark:text-white">Loved by Creators</h2>
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">Join thousands of professionals upgrading their audio.</p>
      </motion.div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {reviews.map((r, i) => (
          <motion.div key={i} variants={fadeInUp} className="glass-card p-6 rounded-2xl flex flex-col justify-between">
...
function FAQSection() {
  ...
  return (
    <motion.section
      initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}
      variants={staggerContainer}
      className="max-w-3xl mx-auto px-4 sm:px-6 w-full mb-20"
    >
      <motion.div variants={fadeInUp} className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-navy dark:text-white">Frequently Asked Questions</h2>
      </motion.div>
